...
class ProgressBar extends UIComponent
{
	...
	public function new(name:String = null, xflSymbolArguments:XFLSymbolArguments = null)
	{
		...
		getXFLDisplayObject("ProgressBar_barSkin").x = (getXFLDisplayObject("ProgressBar_trackSkin").width - getXFLDisplayObject("ProgressBar_barSkin")
			.width) / 2.0;
		getXFLDisplayObject("ProgressBar_barSkin").y = (getXFLDisplayObject("ProgressBar_trackSkin").height - getXFLDisplayObject("ProgressBar_barSkin")
			.height) / 2.0;
	...
	private function updateBar()
	{
		...
		{
			getXFLDisplayObject("ProgressBar_barSkin")
				.width = getXFLDisplayObject("ProgressBar_barSkin").scale9Grid != null && barWidth < getXFLDisplayObject("ProgressBar_barSkin").scale9Grid.left ? getXFLDisplayObject("ProgressBar_barSkin").scale9Grid.left : barWidth;
		}
