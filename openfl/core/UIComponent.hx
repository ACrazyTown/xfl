...
class UIComponent extends XFLSprite
{
	...
	public function new(name:String, xlfSymbolArguments:XFLSymbolArguments = null)
	{
		...
		if (getXFLDisplayObject("focusRectSkin") != null)
			removeChild(getXFLDisplayObject("focusRectSkin"));
	}
	...
	{
		if (Std.isOfType(value, DisplayObject) == true && cast(value, DisplayObject).parent != null)
		{
