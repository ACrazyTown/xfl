...
class XFLImplementation
{
	...
	public function getXFLElement(name:String):XFLElement
	{
		...
		if (element != null)
			return cast(element, XFLElement);
		return null;
	}
	...
	public function getXFLMovieClip(name:String):XFLMovieClip
	{
		var element:Dynamic = getXFLElementUntyped(name);
		if (element != null)
			return cast(element, XFLMovieClip);
		return null;
	}
	...
	public function getXFLDisplayObject(name:String):DisplayObject
	{
		var element:Dynamic = getXFLElementUntyped(name);
		if (element != null)
			return cast(element, DisplayObject);
		return null;
	}
	...
	public function getXFLDisplayObjectContainer(name:String):DisplayObjectContainer
	{
		var element:Dynamic = getXFLElementUntyped(name);
		if (element != null)
			return cast(element, DisplayObjectContainer);
		return null;
	}
	...
	public function getXFLRadioButton(name:String):RadioButton
	{
		var element:Dynamic = getXFLElementUntyped(name);
		if (element != null)
			return cast(element, RadioButton);
		return null;
	}
	...
	public function getXFLUIScrollBar(name:String):UIScrollBar
	{
		var element:Dynamic = getXFLElementUntyped(name);
		if (element != null)
			return cast(element, UIScrollBar);
		return null;
	}
	...
	public function getXFLUIComponent(name:String):UIComponent
	{
		var element:Dynamic = getXFLElementUntyped(name);
		if (element != null)
			return cast(element, UIComponent);
		return null;
	}
	...
	public function getXFLScrollPane(name:String):ScrollPane
	{
		var element:Dynamic = getXFLElementUntyped(name);
		if (element != null)
			return cast(element, ScrollPane);
		return null;
	}
	...
	public function getXFLProgressBar(name:String):ProgressBar
	{
		var element:Dynamic = getXFLElementUntyped(name);
		if (element != null)
			return cast(element, ProgressBar);
		return null;
	}
	...
	public function getXFLCellRenderer(name:String):CellRenderer
	{
		var element:Dynamic = getXFLElementUntyped(name);
		if (element != null)
			return cast(element, CellRenderer);
		return null;
	}
